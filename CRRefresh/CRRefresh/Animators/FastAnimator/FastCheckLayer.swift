...
class FastCheckLayer: CALayer {
    ...
    func startAnimation() {
        ...
        start.duration = 0.5
        start.timingFunction = CAMediaTimingFunction(name: CAMediaTimingFunctionName.easeIn)
        ...
        end.timingFunction = CAMediaTimingFunction(name: CAMediaTimingFunctionName.easeIn)
